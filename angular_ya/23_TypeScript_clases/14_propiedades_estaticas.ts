...
class Dado {
  ...
  //La propiedad 'valor' es independiente en cada dado 
  //pero la propiedad 'tiradas' es compartida por los dos objetos.
  ...
  private generar() {
    ...
    //Para acceder a dichas propiedades debemos anteceder el nombre de la clase 
    //y no la palabra clave 'this':
    Dado.tiradas++;
  }
...
//No importan cuantos objetos de la clase se definan luego todos esos objetos comparten 
//la misma variable estática:
let dado1 = new Dado();
dado1.tirar();
dado1.imprimir();
