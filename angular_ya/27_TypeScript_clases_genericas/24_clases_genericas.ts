...
Para entender las ventajas de definir clases genéricas implementaremos los algoritmos 
para administrar una pila de enteros y una pila de string. 
...
//Como podemos analizar hemos planteado dos clases, una para administrar una pila 
//con tipos de dato enteros:
class PilaEnteros {
  private vec: number[] = [];
...
//Para probar estas dos clases definimos un objeto de la clase PilaEnteros 
//e insertamos tres valores y luego extraemos uno:
...
//se imprime un 1 ya que el último en entrar es el primero en salir en una pila.
...
//Como vemos hemos declarado una sola clase llamada PilaGenerica y hemos sustituido en 
//los lugares donde hacíamos referencia a number o string por el tipo 'T' que también 
//tenemos que hacer referencia en donde declaramos la clase:
...
//Luego cuando creamos un objeto de la clase PilaGenerica debemos indicar cuando la 
//creamos el tipo de datos que administrará nuestra pila:
...
//Creamos un objeto de la clase PilaGenerica e indicamos que almacenará objetos 
//de la clase Persona:
...
//El planteo de clases genéricas nos reduce tener que crear múltiples clases 
//para administrar distintos tipos de datos.