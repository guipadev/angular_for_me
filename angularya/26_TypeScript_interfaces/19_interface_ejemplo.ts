...
//En este problema la interface Figura tiene dos métodos que deben ser implementados por las clases 
//y dos propiedades que también deben definirlos:
interface Figura {
    superficie: number;
    perimetro: number;
...
//La clase Cuadrado indica que implementa la interface Figura, esto hace necesario que se implementen los métodos calcularSuperficie 
...
//Las interfaces exige que una clase siga las especificaciones de la misma y se implementen algoritmos más robustos. 
//En nuestro ejemplo tanto la clase Rectangulo como Cuadrado tienen una forma similar de trabajar gracias a que implementan la interfaz Figura.
